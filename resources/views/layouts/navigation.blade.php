@php
    $user = auth()->user();
    $dashboardUrl = Route::has('admin.dashboard.index') ? route('admin.dashboard.index') : url('/');
    $hasDashboardRoute = Route::has('admin.dashboard.index');
    $hasProfileRoute = Route::has('profile.edit');
