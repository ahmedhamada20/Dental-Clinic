...
@section('title', __('admin.promotions.create_title'))
...
@section('breadcrumb')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('admin.promotions.actions.create') }}</li>
        </ol>
    </nav>
@endsection
        ...
        <div class="col-lg-9">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>{{ __('admin.promotions.create_new') }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.promotions.store') }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control font-monospace @error('code') is-invalid @enderror"
                                       id="code" name="code" value="{{ old('code') }}" placeholder="{{ __('admin.promotions.placeholders.code') }}">
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <select class="form-select @error('promotion_type') is-invalid @enderror"
                                    ...
                                    @foreach($promotionTypes as $pt)
                                        <option value="{{ $pt['value'] }}" {{ old('promotion_type') === $pt['value'] ? 'selected' : '' }}>
                                            {{ $pt['label'] }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" min="0"
                                       ...
                                       placeholder="{{ __('admin.promotions.placeholders.value') }}">
                            ...
                            <div class="col-12 mb-4">
                                <label class="form-label">
                                    {{ __('admin.promotions.assign_to_services') }}
                                    <small class="text-muted">({{ __('admin.promotions.assign_to_services_help') }})</small>
                                </label>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-success">
                                <i class="bi bi-check-circle me-1"></i>{{ __('admin.promotions.actions.create') }}
                            </button>
