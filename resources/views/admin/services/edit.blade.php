        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="bi bi-pencil-square me-2"></i>Edit Service — {{ $service->name_en ?? $service->name_ar }}</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name_ar') is-invalid @enderror"
                                       id="name_ar" name="name_ar" value="{{ old('name_ar', $service->name_ar) }}" required>
                                ...
                                <select class="form-select" id="medical_specialty_id" name="medical_specialty_id" data-filter="specialty">
                                    ...
                                    @foreach($specialties as $specialty)
                                        <option value="{{ $specialty->id }}"
                                            {{ (string) old('medical_specialty_id', $selectedSpecialtyId ?? null) === (string) $specialty->id ? 'selected' : '' }}>
                                            {{ $specialty->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('description_ar') is-invalid @enderror"
                                          id="description_ar" name="description_ar" rows="3">{{ old('description_ar', $service->description_ar) }}</textarea>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('description_en') is-invalid @enderror"
                                          id="description_en" name="description_en" rows="3">{{ old('description_en', $service->description_en) }}</textarea>
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_bookable"
                                               ...
                                               {{ old('is_bookable', $service->is_bookable) ? 'checked' : '' }}>
